...
plot((accessory_per_seed)~(prepollen_all_per_seed),SummaryInd, log="xy",pch=16,col=col.spp[as.factor(species)],ylab="accessory costs per successful seed",cex=0.9)
...
plot(asin(sqrt(prop_accessory))~asin(sqrt(prop_prepollen_all)),SummaryInd, log="", pch=16,col=col.spp[as.factor(species)],ylab="proportional accessory costs",cex=0.9)
...
###5. What influences the correlation between RA and plant size (or total reproductive investment)?
  ***Don't trust anything until I know RA and ReproInv are correct, because PHPH and PUTU have huge influence on patterns
