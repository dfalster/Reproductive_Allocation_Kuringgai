```{r}
par(mfrow=c(1,1), cex=1, omi=c(.1,.1,.1,.1), mai=c(.5,.5,.5,.5)) 
SummaryInd$costs_for_seed <- SummaryInd$seed_count * SummaryInd$seedcosts
SummaryInd$costs_for_aborted <- SummaryInd$repro_inv - SummaryInd$costs_for_seed
plot(costs_for_seed ~ costs_for_aborted,data=subset(SummaryInd,repro_inv>0),col=col.spp(species),pch=16,log="xy")
SummaryInd$prop_aborted <- SummaryInd$costs_for_aborted / SummaryInd$repro_inv
plot(prop_aborted ~ age, data=subset(SummaryInd,repro_inv>0),col=col.spp(species),pch=16,log="x")
...
plot(propagule_inv~total_weight_0,data=subset(SummaryInd,propagule_inv>0),col=col.spp(species),pch=16,log="xy",xlim=c(10,10000000),ylim=c(1,1000000))
...
win.metafile("figs2/accessory_per_seed_vs_seed_size.wmf", height=6, width=6)
plot
plot(accessory_per_seed~seed_size,data=subset(SummaryInd),col=col.spp(species),pch=16,log="xy")
points(accessory_per_seed~seed_size,data=subset(SummarySpp[["mean"]]),col=col.spp(species),pch=16,cex=2)
...
plot(accessory_per_seed~costs_per_seed,data=subset(SummaryInd),col=col.spp(species),pch=16,log="y")
plot(propagule_inv~accessory_inv,data=subset(SummaryInd),col=col.spp(species),pch=16,log="xy")
