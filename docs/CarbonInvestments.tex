...
\graphicspath{{images/}{../output/docs/}}
...
\subsection{Overview}
\includegraphics[width=1\linewidth]{../output/docs/IAT_Comparison.pdf}
\clearpage
\newpage
\section{Individual species}
\subsection{BAER}
\includegraphics[width=1\linewidth]{../output/docs/IAT_BAER.pdf}

\subsection{BOLE}
\includegraphics[width=1\linewidth]{../output/docs/IAT_BOLE.pdf}

\subsection{COER}
\includegraphics[width=1\linewidth]{../output/docs/IAT_COER.pdf}

\subsection{EPMI}
\includegraphics[width=1\linewidth]{../output/docs/IAT_EPMI.pdf}

\subsection{GRBU}
\includegraphics[width=1\linewidth]{../output/docs/IAT_GRBU.pdf}

\subsection{GRSP}
\includegraphics[width=1\linewidth]{../output/docs/IAT_GRSP.pdf}

\subsection{HATE}
\includegraphics[width=1\linewidth]{../output/docs/IAT_HATE.pdf}

\subsection{HEPU}
\includegraphics[width=1\linewidth]{../output/docs/IAT_HEPU.pdf}

\subsection{LEES}
\includegraphics[width=1\linewidth]{../output/docs/IAT_LEES.pdf}

\subsection{PELA}
\includegraphics[width=1\linewidth]{../output/docs/IAT_PELA.pdf}

\subsection{PEPU}
\includegraphics[width=1\linewidth]{../output/docs/IAT_PEPU.pdf}

\subsection{PHPH}
\includegraphics[width=1\linewidth]{../output/docs/IAT_PHPH.pdf}

\subsection{PILI}
\includegraphics[width=1\linewidth]{../output/docs/IAT_PILI.pdf}

\subsection{PUTU}
\includegraphics[width=1\linewidth]{../output/docs/IAT_PUTU.pdf}
