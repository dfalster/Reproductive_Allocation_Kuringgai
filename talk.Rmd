...
```{r, echo=FALSE,results='hide', message=FALSE}
#DF: Here is a place where it would be good to run the statistical model on each of the species. I have the function I wrote below, ut hashed out
...
#mod_LLvAge <- function(spp) {
#  lm(LL_birth ~ age, data=subset(SummaryInd,species==spp))
#}
...
#Some other teasers for the future
