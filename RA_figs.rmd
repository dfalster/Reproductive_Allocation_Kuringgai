...
SummaryIndPCA <- SummaryInd %>%
  ...
  select(prop_maxH,height,maxH_spp,wood_density,LMA_mean,seed_size,growth_leaf,
...
* top variable loadings: scaled_growth_stem_diam, wood_density,growth_stem_diam, lvs_end_total vs. maxH_spp, LMA_mean, seed_size, RA  
