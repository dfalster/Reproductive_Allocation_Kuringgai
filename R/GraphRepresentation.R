...
make_LEES_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  # Setting colours indicating main progression line together with its XORs. The accesorry tissues are to have different colour, mark only the final element of the
  # accesory line! Accesorries to the same line are to be marked in their own colour of value 1 larger than the path itself
