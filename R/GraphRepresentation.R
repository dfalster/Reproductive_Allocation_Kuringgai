...
make_OrderedListsOfParts_LEES <- function() {
  c("bud_tiny", "bud_mid", "bud_aborted", "bud_big", "flower_petals", "flower_calyx", "finished_flower", "fruit_just_starting", "fruit_young", "calyx_fruit",
    "fruit_large_immature", "fruit_aborted", "fruit_mature")
  }

make_OrderedListsOfParts_GRBU <- function() {
  c("inflorescence_bud_small", "inflorescence_stalk", "bud_tiny", "bud_small", "bud_mid", "bud_big", "flower_petals", "flower_stigma", "finished_flower_stigma",
    "fruit_just_starting", "fruit_young", "pedicel", "fruit_large_immature", "seed_pod", "seed", "seed_aborted")
}

make_OrderedListsOfParts_GRSP <- function() {
  c("inflorescence_bud_small", "inflorescence_stalk", "bud_tiny", "inflorescence_stalk_in_fruit", "bud_small", "bud_mid", "bud_big", "bud_just_opening",
    "flower_petals", "flower_stigma", "finished_flower_stigma", "fruit_just_starting", "fruit_young", "pedicel", "fruit_large_immature", "seed_pod", "seed_aborted",
    "seed")
}
...
make_OrderedListsOfParts_COER <- function() {
  c("inflorescence_bud_tiny", "inflorescence_bud_mid", "inflorescence_stalk", "bud_big", "inflorescence_stalk_in_fruit", "inflorescence_stalk_in_fruit_large",
    "inflorescence_stalk_in_fruit_very_large", "flower_petals", "flower_stigma", "finished_flower", "fruit_just_starting", "bract_fruit", "fruit_young", "fruit_large_immature",
    "fruit_mature", "flower_all_parts")
}

make_OrderedListsOfParts_PUTU <- function() {
  c("bud_big", "flower_petals", "flower_calyx", "bract_flower_or_finished_flower", "flower_stigma", "finished_flower_stigma", "flower_aborted", "fruit_large_immature",
    "fruit_aborted", "seed_pod", "seed", "seed_aborted")
}

make_OrderedListsOfParts_BAER <- function() {
  c("cone_base_green", "cone_base_brown", "cone_green", "cone_brown", "cone_brown_no_expanded_follicles", "cone_aborted", "bud_tiny", "bud_small",
    "bud_mid", "bud_big", "bud_just_opening", "flower_petals", "flower_style", "flower_stigma", "finished_flower_stigma", "fruit_just_starting", "fruit_young", "fruit_large_immature",
    "seed_pod", "seed", "seed_aborted")
}

make_OrderedListsOfParts_BOLE <- function() {
  c("bud_tiny", "bud_small", "bud_mid", "bud_big", "pedicel", "flower_petals", "late_flower_petals", "flower_calyx", "finished_flower", "finished_flower_stigma",
...
make_OrderedListsOfParts_PILI <- function() {
  c("inflorescence_bud_mid", "inflorescence_stalk", "bract_flower_or_finished_flower", "bud_big", "flower_calyx", "flower_stigma", "flower_petals",
    "fruit_young", "fruit_large_immature", "fruit_aborted", "seed_pod", "seed")
}

make_OrderedListsOfParts_PHPH <- function() {
  c("bud_small", "bud_mid", "flower_petals_small", "flower_petals", "bract_flower_or_finished_flower", "flower_calyx", "flower_stigma", "flower_aborted",
    "flower_aborted_without_petals", "finished_flower_stigma", "fruit_just_starting", "fruit_young", "fruit_large_immature", "fruit_aborted", "seed_pod", "seed",
    "seed_aborted")
}

make_OrderedListsOfParts_PELA <- function() {
  c("bud_small", "bud_mid", "bud_big", "flower_petals", "pedicel", "flower_stigma", "finished_flower_stigma", "fruit_just_starting", "fruit_young",
    "fruit_large_immature", "seed", "seed_pod")
}

make_OrderedListsOfParts_HATE <- function() {
  c("inflorescence_bud_tiny", "inflorescence_bud_small", "inflorescence_bud_mid", "inflorescence_bud_big_bracts", "inflorescence_bud_big_flowers",
    "flower_petals", "flower_stigma", "finished_flower_stigma", "fruit_just_starting", "fruit_young", "fruit_large_immature", "fruit_aborted", "seed_pod", "seed_immature",
    "seed_aborted", "seed")
}

make_OrderedListsOfParts_PEPU <- function() {
  c("cone_just_starting", "cone_young", "cone_green", "cone_brown", "cone_aborted", "bud_tiny", "bud_big", "bud_aborted", "flower_petals", "flower_calyx",
    "flower_stigma", "fruit_just_starting", "fruit_young", "fruit_large_immature", "fruit_empty", "fruit_mature", "fruit_aborted")
}
...
AdjustEdgeWeightsForMultiplicity <- function(graph, species, MultiplierTable) {
  ...
  for (i in seq_len(nrow(EdgeList))) {
    from <- EdgeList[i, 1]
    to <- EdgeList[i, 2]
    MultiplierFrom <- MultiplierTable[MultiplierTable$flower_part == from, species]
...
make_LEES_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  LEES.graph <- graph.formula("bud_tiny" - "bud_mid" - "bud_big" - "flower_calyx" - "finished_flower" - "fruit_just_starting" - 
                                "fruit_young" - "fruit_large_immature_01" - "fruit_mature", 
                              "bud_tiny" - "bud_aborted", 
                              "bud_big" - "flower_petals", 
                              "fruit_young" - "calyx_fruit", 
                              "fruit_young" - "fruit_aborted")
  from <- "bud_tiny"
  to <- "fruit_mature"
  Paths <- data.frame(from = from, to = to)
  # Setting colours indicating main progression line together with its XORs. The accessory tissues are to have different colour, mark only the final element of the
  # accessory line! Accessories to the same line are to be marked in their own colour of value 1 larger than the path itself
  ...
  # Setting edge weight which defines how much of carbon is beeing directed from each part to each part. Especially important for species with accessories All
  # edges get weight 1
  LEES.graph <- set.edge.attribute(LEES.graph, name = "weight", value = 1)
  # Multiplicity adjust weights
  LEES.graph <- AdjustEdgeWeightsForMultiplicity(graph = LEES.graph, species = "LEES", MultiplierTable)
...
make_GRBU_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  GRBU.graph <- graph.formula("bud_tiny" - "bud_small" - "bud_mid" - "bud_big" - "flower_stigma" - "finished_flower_stigma" - "fruit_just_starting" - "fruit_young" - 
                              "fruit_large_immature_01" - "fruit_large_immature_02" - "fruit_large_immature_03" - "fruit_large_immature_04" - 
                              "fruit_large_immature_05" - "fruit_large_immature_06" - "seed", 
                              "inflorescence_bud_small" - "inflorescence_stalk", 
                              "bud_big" - "flower_petals", 
                              "fruit_young" - "pedicel", 
                              "fruit_large_immature_06" - "seed_pod", 
                              "fruit_large_immature_06" - "seed_aborted")
  ...
  # Setting edge weight which defines how much of carbon is beeing directed from each part to each part. Especially important for species with accessories
  GRBU.graph <- set.edge.attribute(GRBU.graph, name = "weight", value = 1)
  # Multiplicity adjust weights
  GRBU.graph <- AdjustEdgeWeightsForMultiplicity(graph = GRBU.graph, species = "GRBU", MultiplierTable)
  # We modify the edges for those parts which are result of branching on the plant map
...
make_GRSP_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  GRSP.graph <- graph.formula("bud_tiny" - "bud_small" - "bud_mid" - "bud_big" - "bud_just_opening" - "flower_stigma" - "finished_flower_stigma" - "fruit_just_starting" - "fruit_young" - 
                                "fruit_large_immature_01" - "fruit_large_immature_02" - "fruit_large_immature_03" - "fruit_large_immature_04" - "fruit_large_immature_05" - 
                                "fruit_large_immature_06" - "seed", 
                              "inflorescence_bud_small" - "inflorescence_stalk" - "inflorescence_stalk_in_fruit", 
  ...
  # Multiplicity adjust weights
  GSP.graph <- AdjustEdgeWeightsForMultiplicity(graph = GRSP.graph, species = "GRSP", MultiplierTable)
  # We modify the edges for those parts which are result of branching on the plant map
...
make_PUTU_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  ## flower_petals, flower_calyx, flower_stigma,bract_flower_or_finished_flower from bud big which edges
...
make_BAER_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  BAER.graph <- graph.formula("cone_base_green_01" - "cone_base_green_02" - "cone_base_green_03" - "cone_base_green_04" - "cone_base_brown", 
                              ...
                              "cone_young_04" - "cone_aborted", 
                              "bud_tiny" - "bud_small" - "bud_mid" - "bud_big" - "bud_just_opening" - "flower_stigma" - 
...
make_PILI_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  PILI.graph <- graph.formula("bud_big" - "flower_stigma" - "fruit_young" - "fruit_large_immature_01" - "seed", 
                              "inflorescence_bud_mid" - "inflorescence_stalk", 
  ...
  ## inflorescence_stalk, bract_flower_or_finished_flower from inflorescence_bud_mid which edges
...
make_PHPH_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  PHPH.graph <- graph.formula("bud_small" - "bud_mid" - "flower_stigma" - "finished_flower_stigma" - "fruit_just_starting" - "fruit_young" - "fruit_large_immature_01" - "seed", 
                              "bud_mid" - "flower_petals_small" - "flower_petals", 
                              "bud_mid" - "bract_flower_or_finished_flower", 
                              "bud_mid" - "flower_calyx", "bud_small" - "flower_aborted",
                              "flower_aborted_without_petals", 
                              "fruit_young" - "fruit_aborted", 
                              "fruit_large_immature_01" - "seed_pod", 
                              "fruit_large_immature_01" - "seed_aborted")
  ...
  ## flower_petals_small, bract_flower_or_finished_flower, flower_stigma,flower_calyx from bud_mid which edges
...
make_PELA_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  PELA.graph <- graph.formula("bud_small" - "bud_mid" - "bud_big" - "flower_stigma" - "finished_flower_stigma" - "fruit_just_starting" - "fruit_young" - 
                                "fruit_large_immature_01" - "fruit_large_immature_02" - "fruit_large_immature_03" - 
                                "fruit_large_immature_04" - "fruit_large_immature_05" - "fruit_large_immature_06" - "seed", 
                              "bud_big" - "flower_petals", 
                              "bud_big" - "pedicel", 
                              "fruit_large_immature_06" - "seed_pod")
  from <- c("bud_small")
...
make_HATE_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  HATE.graph <- graph.formula("inflorescence_bud_tiny" - "inflorescence_bud_small" - "inflorescence_bud_mid" - "inflorescence_bud_big_flowers" - "flower_stigma" - 
                                "finished_flower_stigma" - "fruit_just_starting" - "fruit_young" - "fruit_large_immature_01" - "seed_immature" - "seed", 
                              "inflorescence_bud_mid" - "inflorescence_bud_big_bracts",
                              "inflorescence_bud_big_flowers" - "flower_petals", 
                              "fruit_young" - "fruit_aborted", 
                              "fruit_large_immature_01" - "seed_pod", 
                              "fruit_large_immature_01" - "seed_aborted")
  ...
  ## inflorescence_bud_big_bracts, inflorescence_bud_big_flowers from inflorescence_bud_mid which edges
...
make_PEPU_GraphMaps <- function(PartsSummary, MultiplierTable){
  ...
  PEPU.graph <- graph.formula("bud_tiny" - "bud_big" - "flower_stigma" - "fruit_just_starting" - "fruit_young" - "fruit_large_immature_01" - "fruit_mature", 
                              "cone_just_starting_01" - "cone_just_starting_02" - "cone_just_starting_03" - "cone_just_starting_04" - "cone_just_starting_05" - 
                                "cone_young_01" - "cone_young_02" - "cone_young_03" - "cone_young_04" - "cone_green_01" - "cone_green_02" - "cone_green_03" - "cone_green_04" - "cone_brown", 
                              "cone_green_04" - "cone_aborted", "bud_tiny" - "bud_aborted",
                              "bud_big" - "flower_petals", 
                              "bud_big" - "flower_calyx", 
                              "fruit_large_immature_01" - "fruit_empty", 
                              "fruit_just_starting" - "fruit_aborted")
