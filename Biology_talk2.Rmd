repro vs. leaf investment for all species
...
plot((1+repro_inv)~growth_leaf, SummaryInd, log="xy", col=col.spp(species),pch=16,xlim=c(1,1000000),ylim=c(1,1000000),xlab="",ylab="")
...
mtext("leaf investment (mg)", 1, outer=TRUE,cex=1,line=1.7)
dev.off()
```
...
for(spp in names(data)) {
  ...
  plot_yvar_vs_xvar(data[[spp]], yvar, xvar,log="x",xlab="",ylab="",xlim=c(1,33),ylim=c(0,2),cex=1,
                    col=col.age(data[[spp]]$age),main=labels.spp.full(spp),cex.main=0.9)
  points(RA_leaf_area~age,data2[[spp]],pch=16,cex=0.8)
}
...
reproductive investment by age for 4 species
```{r, echo=FALSE,message=FALSE,warning=FALSE, fig.width=18, fig.height=15}
...
leaf investment by age for 4 species
```{r, echo=FALSE,message=FALSE,warning=FALSE, fig.width=18, fig.height=15}
...
leaf weight by age for 4 species
```{r, echo=FALSE,message=FALSE,warning=FALSE, fig.width=18, fig.height=15}
...
reproductive investment vs. leaf investment for 4 species
```{r, echo=FALSE,message=FALSE,warning=FALSE, fig.width=18, fig.height=15}
...
par(mfcol=c(4,1), cex=1, omi=c(.6,.6,.01,.01), mai=c(.4,.1,.3,0.1))
...
mtext("leaf investment (mg) (log scale)", 2, outer=TRUE,cex=1,line=1)
mtext("reproductive investment (mg)", 1, outer=TRUE,cex=1,line=1.7)
dev.off()
```


##Daniel, don't worry past here
