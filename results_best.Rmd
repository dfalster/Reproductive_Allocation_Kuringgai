...
##haven't continued with remaining species, because of problems described
accessory_count <- rbind(BAER_count,BOLE_count,COER_count,EPMI_count,GRBU_count,GRSP_count)
```
