...
plot(LL_death~shoot_leaf_area,data=subset(SummaryInd,LL_death<6),log="x",pch=16,col=col.spp(species))
mod <- lm(log(shoot_leaf_area)~LL_death,data=subset(SummaryInd,LL_death<6))
words.top.right.logx(mod)

plot(LL_death~leaf_area,data=subset(SummaryInd,LL_death<6),log="x",pch=16,col=col.spp(species))
...
plot(wood_density~growth_leaf_area,SummaryInd,log="y",pch=16,col=col.age(age)
