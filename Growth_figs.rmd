...
```{r, echo=FALSE,message=FALSE,warning=FALSE, fig.width=14, fig.height=7}
par(mfrow=c(1,2), cex=1, omi=c(0.2,0.3,0.3,0.3), mai=c(1.1,1,0.3,0.3)) 
plot(growth_stem_diameter~prop_maxH,SummaryInd,log="y",pch=16,col=col.spp[as.factor(species)])
```
...
```{r, echo=FALSE,message=FALSE,warning=FALSE, fig.width=14, fig.height=7}
par(mfrow=c(1,2), cex=1, omi=c(0.2,0.3,0.3,0.3), mai=c(1.1,1,0.3,0.3)) 
plot(growth_leaf_area~prop_maxH,SummaryInd,log="y",pch=16,col=col.spp[as.factor(species)])
```
...
plot(wood_density~growth_leaf_area,SummaryInd,log="y",pch=16,col=col.age[as.factor(age)])
