...
dir.create("ms/Accessory/figures", FALSE, TRUE)
...
dev.off()
pdf("ms/Accessory/figures/proxy.pdf", width = 11L, height = 5L)
figure_proxy(SummaryInd)
dev.off()
...
dev.off()
pdf("ms/Accessory/figures/allocation.pdf", width = 10L, height = 6L)
figure_accessory_bar(SummarySpp)
dev.off()
pdf("ms/Accessory/figures/seed_size_tests.pdf", width = 8L, height = 8L)
figure_accessory_v_seed_size(SummarySpp)
dev.off()
pdf("ms/Accessory/figures/seed_size_scaling.pdf", width = 6L, 
    height = 4L)
figure_scaling_costs_seed_size(SummarySpp)
dev.off()
...
knitr::knit("ms/Accessory/Wenk-Accessory-SI.Rnw", "ms/Accessory/Wenk-Accessory-SI.tex")
latex_build("ms/Accessory/Wenk-Accessory-SI.tex", clean = TRUE)
