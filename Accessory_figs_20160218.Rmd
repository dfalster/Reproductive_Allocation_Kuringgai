...
#seed count, scaled to plant size, decreases 1:1 with seed size, while bud count decreases less steeply; indication that seed count is what is actually "programmed in"
```{r}

win.metafile("figs2/Accessory_Costs/Figure_cost_of_flowers_vs_seed_size.wmf", height=5, width=15)
plot
...
write.csv(results, file="figs2/Accessory_Costs/Table02correlations_with_repro_inv.csv",row.names=FALSE)
```

#Figure 1. Correlations of various reproductive investment categories against plant weight
```{r}
win.metafile("figs2/Accessory_Costs/Figure01_correlations_with_plant_weight.wmf", height=5, width=10)
plot
...
points(scaled_repro_inv~seed_size,SummarySpp[["mean"]], cex=2, col=col.spp(species),pch=16,log="xy")
...
win.metafile("figs2/Accessory_Costs/Figure02_seedsize_vs_reproinv.wmf", height=5, width=5)
plot
...
```{r}
acc_costs_spp <- dplyr::select(SummarySpp[["mean"]],species,seed_size,seedset,accessory_per_seed,prepollencosts,prepollen_all_per_seed,prepollen_failure_per_seed,postpollen_aborted_per_seed,packaging_dispersal_per_seed,prop_accessory_nonzero)
...
```{r}
win.metafile("figs2/Accessory_Costs/Figure02_seed_size_correlations.wmf", height=5, width=15)
plot
...
write.csv(results, file="figs2/Accessory_Costs/Table06a_prepollen_all_per_seed_vs_seedset.csv",row.names=FALSE)
...
write.csv(results, file="figs2/Accessory_Costs/Table06b_postpollen_aborted_per_seed_vs_seedset.csv",row.names=FALSE)
...
write.csv(results, file="figs2/Accessory_Costs/Table_prop_tissues_inv_by_seed_size.csv",row.names=FALSE) 
```
