...
plot(prepollen_failure_per_seed~seed_size,SummarySpp[["mean"]],pch=16,log="xy",col=col.spp(species))
mod <- lm(log(propagule_inv)~log(seed_size),data=subset(SummarySpp[["mean"]],species!="EPMI"))
summary(mod)
...
acc_by_species$variable = c("total accessory costs","prepollen_success","prepollen_failure","total prepollen","c div p","dispersal")
