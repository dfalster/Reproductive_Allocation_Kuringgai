...
GRSP, PILI shows a marginally significant decrease in accessory costs with increasing size (0.05<p<0.10)
...
BOLE, COER, HATE, HEPU, PELA show a significant decrease in accessory costs with increasing age (p<0.05)
EPMI, GRSP, HATE shows a marginally significant decrease in accessory costs with increasing age (0.05<p<0.10)
...
GRSP, HATE, HEPU, PUTU show a significant decrease in aborted buds with increasing size (p<0.05)
```{r, echo=FALSE,results='hide', message=FALSE}
yvar <- "PerPrePol_A"
xvar <- "FinalWeight"
...
BAER, BOLE, COER, GRSP, HATE, HEPU, LEES, PELA, PEPU show a significant decrease in total pre-pollination costs with increasing RA (p<0.05)
```{r, echo=FALSE,results='hide', message=FALSE}
yvar <- "PerPrePol_All"
xvar <- "RA"
...
LEES and PELA show a marginally significant decrease in total pre-pollination costs with increasing reproductive investment (0.05<p<0.10)
```{r, echo=FALSE,results='hide', message=FALSE}
yvar <- "PerPrePol_All"
xvar <- "ReproInv"
