...
write.csv(results, file="ms/Accessory/output/TableS3a_accessory_vs_all_repro.csv",row.names=FALSE)
...
write.csv(results, file="ms/Accessory/output/TableS3b_accessory_vs_total_weight.csv",row.names=FALSE)
...
write.csv(results, file="ms/Accessory/output/TableS3c_accessory_vs_age.csv",row.names=FALSE)
```
