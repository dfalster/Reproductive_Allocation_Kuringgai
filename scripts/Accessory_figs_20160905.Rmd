plot(seedset~scaled_provisioning_costs,SummarySpp[["mean"]],pch=16,log="xy",col=col.spp(species),yaxt="n",xaxt="n",ylab="",xlab="",cex=1)

mod_ovule <- sma(choosiness~prop_pollen_attract_vs_success,data=SummarySpp[["mean"]],log="xy",method="SMA")
...
mod_x <- sma(accessory_inv~embryo_endo_inv,data=SummarySpp[["mean"]],log="xy",method="SMA")
mod_x <- sma(accessory_costs~embryo_endo_costs,data=SummarySpp[["mean"]],log="xy",method="SMA")
plot(zygote_set~embryo_endo_costs,SummaryInd,pch=16,log="x",col=col.spp(species),cex=1)
