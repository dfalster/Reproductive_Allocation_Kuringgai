...
mod1 <- sma(scaled_ovule_count ~ prepollen_costs, data=subset(SummarySpp[["mean"]]),method="SMA", log="xy",slope.test=mod2$groupsummary["Slope"][[1]],elev.test=mod2$coef[[1]][1,1])

plot(scaled_ovule_count ~ prepollen_costs, SummarySpp[["mean"]],log="xy",pch=1,col=col.spp(species),xlab="cost to make a unit: dashed =ovule; solid=seed",ylim=c(.001,500),ylab="scaled count",xlim=c(.01,5000),cex=1.5)
...
#arrows(SummarySpp[["mean"]]$seed_costs,SummarySpp[["mean"]]$scaled_seed_count,SummarySpp[["mean"]]$prepollen_costs,SummarySpp[["mean"]]$scaled_ovule_count,col=col.spp(SummarySpp[["mean"]]$species),code=0,length=.15)

dev.off()
```

mod_seed <- sma(scaled_seed_count ~ seed_costs, data=subset(SummaryInd),method="SMA", log="xy",slope.test=-1)
mod_ovule <- sma(scaled_ovule_count ~ prepollen_costs, data=subset(SummaryInd),method="SMA", log="xy",slope.test=mod2$groupsummary["Slope"][[1]],elev.test=mod2$coef[[1]][1,1])

plot(scaled_ovule_count ~ prepollen_costs, SummaryInd,log="xy",pch=1,col=col.spp(species),xlab="cost to make a unit: dashed =ovule; solid=seed",ylim=c(.0001,1000),ylab="scaled count",xlim=c(.001,10000),cex=1.5)
...
line_function_log_xy(SummarySpp[["mean"]]$prepollen_costs,mod_ovule,3)
...
plot(prepollen_costs ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",pch=16,col=col.spp(species),ylim=c(.005,5000))
points(prepollen_all_per_seed ~ embryo_endo_size, SummarySpp[["mean"]],pch=1,col=col.spp(species))
#points(prepollen_failure_per_seed ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",pch="-",col=col.spp(species))
...
mod_prepollen_costs <- sma(prepollen_costs ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",method="SMA",slope.test=mod_repro_costs$coef[[1]][2,1])
line_function_log_xy(SummarySpp[["mean"]]$prepollen_all_per_seed,mod_prepollen_all,3)
line_function_log_xy(SummarySpp[["mean"]]$prepollen_costs,mod_prepollen_costs,1)

summary(mod_prepollen_all)
summary(mod_prepollen_costs)
...
mod <- sma(repro_all_count~total_weight,SummaryInd,method="SMA",log="xy",slope=1)
summary(mod)
...
mod <- sma(accessory_per_seed_using_ee ~ embryo_endo_size, data=subset(SummarySpp[["mean"]]),method="SMA", log="xy",slope.test=1)
summary(mod)
...
mod <- sma(prop_prepollen_costs ~ seedset, data=subset(SummarySpp[["mean"]]),method="SMA", log="x",slope.test=1)
summary(mod)
plot(prop_prepollen_costs ~ seedset, SummarySpp[["mean"]],log="",pch=16,col=col.spp(species))



mod <- sma(scaled_ovule_count ~ prepollen_costs, data=subset(SummarySpp[["mean"]]),method="SMA", log="xy",slope.test=-1)
summary(mod)
...
mod <- sma(prop_prepollen_costs~seedset,data=subset(SummarySpp[["mean"]]),log="x",slope=1,method="SMA")
summary(mod)
...
mod <- sma(prop_prepollen_costs~scaled_ovule_count,data=subset(SummarySpp[["mean"]]),log="x",slope=1,method="SMA")
summary(mod)
...
plot(prop_prepollen_costs~seedset,SummarySpp[["mean"]],col=col.spp(species),pch=16,log="")
...
y.error.bars(SummarySpp[["mean"]]$embryo_endo_size,SummarySpp[["mean"]]$repro_inv_per_seed,SummarySpp[["se"]]$accessory_per_seed)
...
plot(prop_prepollen_costs_all_repro~ seedset,data=subset(SummarySpp[["mean"]]),col=col.spp(species),pch=16,log="xy",cex=1.5)
...
slopes <- sma(prepollen_costs ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1,method="SMA", log="xy")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
acc_by_species <- dplyr::bind_rows(acc_by_species, dplyr::select(slopes$groupsummary,r2,pval,Slope,Slope_lowCI,Slope_highCI,Int,Int_lowCI,Int_highCI,Slope_test_p))
...
slopes <- sma(prepollen_failure_per_seed ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1, log="xy",method="SMA")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
acc_by_species <- dplyr::bind_rows(acc_by_species, dplyr::select(slopes$groupsummary,r2,pval,Slope,Slope_lowCI,Slope_highCI,Int,Int_lowCI,Int_highCI,Slope_test_p))
...
slopes <- sma(postpollen_aborted_per_seed ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1, log="xy",method="SMA")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
acc_by_species <- dplyr::bind_rows(acc_by_species, dplyr::select(slopes$groupsummary,r2,pval,Slope,Slope_lowCI,Slope_highCI,Int,Int_lowCI,Int_highCI,Slope_test_p))
...
points(scaled_ovule_count~prepollen_costs,SummaryInd,pch=21,col=col.spp(species))
...
mod_ovule <- sma(scaled_ovule_count~prepollen_costs,data=subset(SummaryInd,scaled_ovule_count!=0),log="xy",method="SMA",slope.test=mod_seed$groupsummary["Slope"][[1]],elev.test=mod_seed$coef[[1]][1,1])
...
mod <- sma(prepollen_costs~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA")
...
legend("bottomleft",legend=c("seed count by success costs","initiated ovules count by pollen-attraction costs"),col=c("black","black"),pch=c(16,21),bty="n",cex=0.5)
...
mtext(text="proportion reproductive costs to pollen-attraction costs for 1 ovule",side=1,line=1.3,outer=FALSE,cex=0.8)
...
plot(scaled_seed_count~seed_costs,SummarySpp[["mean"]],pch=16,log="xy",col="#ca0020",xlim=c(.01,5000),ylim=c(5e-4,500),yaxt="n",xaxt="n",ylab="",xlab="",cex=1)
points(scaled_ovule_count~prepollen_costs,SummarySpp[["mean"]],pch=16,col="#0571b0",cex=1)
...
mtext("count, scaled to plant size",2,line=2.3,cex=0.7)

mod_seed <- sma(scaled_seed_count~seed_costs,data=SummarySpp[["mean"]],log="xy",slope=-1,method="SMA")
mod_ovule <- sma(scaled_ovule_count~prepollen_costs,data=SummarySpp[["mean"]],log="xy",method="SMA",slope.test=mod_seed$groupsummary["Slope"][[1]],elev.test=mod_seed$coef[[1]][1,1])

line_function_log_xy(SummarySpp[["mean"]]$seed_costs,mod_seed,1,col="#ca0020")
line_function_log_xy(SummarySpp[["mean"]]$prepollen_costs,mod_ovule,1,col="#0571b0")
legend("bottomleft",legend=c("seed count by success costs","initiated ovules count by","pollen-attraction costs"),col=c("#ca0020","#0571b0","white"),pch=c(16,16,16),bty="n",cex=0.7)
extra.top.left.logxy("a",2,1)

plot(choosiness~prop_prepollen_costs_all_repro,SummarySpp[["mean"]],log="xy",col="#0571b0",pch=16,xlim=c(0.002,.5),ylim=c(3,800),xaxt="n",yaxt="n",cex=1,ylab="",xlab="")
axis(2, at=c(10,100,1000), labels=c(10,100,1000),cex.axis=0.8,las=2)
axis(1, at=c(0.01,0.1), labels=c(0.01,0.1),cex.axis=0.8)
mtext("prop reproductive investment to",1,line=1.7,cex=0.7)
mtext("successful pollen-attraction costs",1,line=2.3,cex=0.7)
mtext("choosiness (ovules:seed)",2,line=2.3,cex=0.7)

mod_choosy <- sma(choosiness~prop_prepollen_costs_all_repro,data=SummarySpp[["mean"]],log="xy",slope=-1,method="SMA")
line_function_log_xy(SummarySpp[["mean"]]$prop_prepollen_costs_all_repro,mod_choosy,1,col="#0571b0")

extra.top.left.logxy("b",2,1)

plot(prop_prepollen_costs~embryo_endo_size,SummarySpp[["mean"]],pch=16,log="x",col="#0571b0",
     ylim=c(-0.1,1.1),xlim=c(.01,100),xlab="",ylab="",xaxt="n",yaxt="n")
points(prop_postpollen_costs~embryo_endo_size,SummarySpp[["mean"]],pch=16,col="#ca0020")
...
legend("bottomleft",legend=c("pollen-attraction costs","provisioning costs"),col=c("#0571b0","#ca0020"),pch=c(16,16),bty="n",cex=0.7)

mod_prop_prepollen_costs <- sma(prop_prepollen_costs~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")
mod_prop_postpollen_costs <- sma(prop_postpollen_costs~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")

line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_prepollen_costs,1,col="#0571b0")
line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_postpollen_costs,1,col="#ca0020")


plot(prop_prepollen_success~embryo_endo_size,SummarySpp[["mean"]],pch=16,log="x",col="#0571b0",ylim=c(-.1,1.1),xlim=c(.01,100),xlab="",ylab="",xaxt="n",yaxt="n")
points(prop_prepollen_failure~embryo_endo_size,SummarySpp[["mean"]],pch=16,col="#ca0020")
extra.top.left.logx("d",2,1)
axis(2, at=c(0,.2,.4,.6,.8,1), labels=c(0,0.2,0.4,0.6,0.8,1),cex.axis=0.8,las=2)
axis(1, at=c(0.01,1,100), labels=c(0.01,1,100),cex.axis=0.8)
mtext("seed size (mg)",1,line=1.8,cex=0.7)
mtext("prop total pollen-attraction investment",2,line=2.3,cex=0.7)
legend("bottomleft",legend=c("successful ovules","aborted ovules"),col=c("#0571b0","#ca0020"),pch=c(16,16),bty="n",cex=0.7)
...
line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_prepollen_success,1,col="#0571b0")
line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_prepollen_failure,1,col="#ca0020")

plot(prop_postpollen_success~embryo_endo_size,SummarySpp[["mean"]],pch=16,log="x",col="#0571b0",ylim=c(-0.1,1.1),xlim=c(.01,100),xlab="",ylab="",xaxt="n",yaxt="n")
points(prop_postpollen_failure~embryo_endo_size,SummarySpp[["mean"]],pch=16,col="#ca0020")
extra.top.left.logx("e",2,1)
axis(2, at=c(0,.2,.4,.6,.8,1), labels=c(0,0.2,0.4,0.6,0.8,1),cex.axis=0.8,las=2)
axis(1, at=c(0.01,1,100), labels=c(0.01,1,100),cex.axis=0.8)
mtext("seed size (mg)",1,line=1.8,cex=0.7)
mtext("prop total provisioning investment",2,line=2.3,cex=0.7)
legend("bottomleft",legend=c("successful zygotes","aborted zygotes"),col=c("#0571b0","#ca0020"),pch=c(16,16),bty="n",cex=0.7)
...
line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_postpollen_success,1,col="#0571b0")
line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_postpollen_failure,1,col="#ca0020")

plot(prepollen_costs~embryo_endo_size,SummarySpp[["mean"]],pch=16,log="xy",col="#0571b0",xlim=c(.002,100),ylim=c(.01,20000),xlab="",ylab="",xaxt="n",yaxt="n")
points(provisioning_costs~embryo_endo_size,SummarySpp[["mean"]],pch=16,col="#ca0020")
...
legend("bottomright",legend=c("pollen-attraction","provisioning"),col=c("#0571b0","#ca0020"),pch=c(16,16),bty="n",cex=0.7)


mod_prepollen_costs <- sma(prepollen_costs~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA")
mod_provisioning_costs <- sma(provisioning_costs~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA",slope.test = mod_prepollen_costs$groupsummary$Slope_highCI)
line_function_log_xy(SummarySpp[["mean"]]$embryo_endo_size,mod_prepollen_costs,1,col="#0571b0")
line_function_log_xy(SummarySpp[["mean"]]$embryo_endo_size,mod_provisioning_costs,1,col="#ca0020")
...
energy_prop <- dplyr::select(mod_prop_prepollen_costs$groupsummary,r2,pval,Slope,Slope_lowCI,Slope_highCI,Int,Int_lowCI,Int_highCI)
energy_prop$test[1] <- "Proportion prepollen costs"
...
plot((repro_all_count/seed_count)~prop_prepollen_costs_all_repro,SummarySpp[["mean"]],pch=16,log="xy",col=col.spp(species),ylab="",ylim=c(.8,500),yaxt="n",xlim=c(.0015,.5),xaxt="n")
...
mtext("proportion reproductive investment for successful pollen-attraction costs",1,line=2.3)

mod_choosy <- sma((repro_all_count/seed_count)~prop_prepollen_costs_all_repro,data=SummarySpp[["mean"]],log="xy",slope=-1,method="SMA")

line_function_log_xy(SummarySpp[["mean"]]$prop_prepollen_costs_all_repro,mod_choosy,1)
summary(mod_choosy)
...
mod_prepollen <- sma(prepollen_costs~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA")
...
legend("topright",legend=c("pollen-attraction","provisioning"),col=c("black","black"),pch=c(16,21),bty="n")
extra.top.left.logxy("c",2,1.2)

plot(prop_prepollen_costs~embryo_endo_size,SummarySpp[["mean"]],col=col.spp(species),pch=16,log="x", yaxt="n",xaxt="n", ylim=c(0,1), xlim=c(.002,500), ylab="",xlab="",cex=1.5)
...
mod_prop_prepollen_costs <- sma(prop_prepollen_costs~embryo_endo_size,SummarySpp[["mean"]],log="x",method="SMA",slope.test=0)
mod_prop_prepollen_all <- sma(prop_prepollen_all~embryo_endo_size,SummarySpp[["mean"]],log="x",method="SMA",slope.test=0)

line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_prepollen_costs,1)

summary(mod_prop_prepollen_costs)
...
mod <- sma(accessory_per_seed~seed_count,data=subset(SummarySpp[["mean"]]),method="SMA", log="xy")
