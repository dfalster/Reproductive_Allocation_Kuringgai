...
mod2 <- sma(scaled_seed_count ~ seed_costs, data=subset(SummarySpp[["mean"]]),method="SMA", log="xy",slope.test=-1)
...
points(scaled_seed_count ~ seed_costs, SummarySpp[["mean"]],cex=1.5,pch=16,col=col.spp(species))
line_function_log_xy(SummarySpp[["mean"]]$pollen_attract_costs,mod1,3)
line_function_log_xy(SummarySpp[["mean"]]$seed_costs,mod2,1)
#points(scaled_seed_count ~ embryo_endo_size, SummarySpp[["mean"]],pch=12,col=col.spp(species))
#arrows(SummarySpp[["mean"]]$seed_costs,SummarySpp[["mean"]]$scaled_seed_count,SummarySpp[["mean"]]$pollen_attract_costs,SummarySpp[["mean"]]$scaled_ovule_count,col=col.spp(SummarySpp[["mean"]]$species),code=0,length=.15)

dev.off()
```

mod_seed <- sma(scaled_seed_count ~ seed_costs, data=subset(SummaryInd),method="SMA", log="xy",slope.test=-1)
mod_ovule <- sma(scaled_ovule_count ~ pollen_attract_costs, data=subset(SummaryInd),method="SMA", log="xy",slope.test=mod2$groupsummary["Slope"][[1]],elev.test=mod2$coef[[1]][1,1])

plot(scaled_ovule_count ~ pollen_attract_costs, SummaryInd,log="xy",pch=1,col=col.spp(species),xlab="cost to make a unit: dashed =ovule; solid=seed",ylim=c(.0001,1000),ylab="scaled count",xlim=c(.001,10000),cex=1.5)
points(scaled_seed_count ~ seed_costs, SummaryInd,cex=1.5,pch=16,col=col.spp(species))


line_function_log_xy(SummaryInd$seed_costs,mod_seed,1)
line_function_log_xy(SummarySpp[["mean"]]$pollen_attract_costs,mod_ovule,3)


par(mfrow=c(1,2), cex=1, omi=c(.1,.1,.05,.05), mai=c(.8,.8,.1,.05)) 
plot(repro_inv_per_seed ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",pch=16,col=col.spp(species),ylim=c(.05,10000))
points(seed_costs ~ embryo_endo_size, SummarySpp[["mean"]],pch=1,col=col.spp(species))
mod_repro_costs <- sma(repro_inv_per_seed ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",method="SMA",slope.test=1)
mod_fixed_costs <- sma(seed_costs ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",method="SMA",slope.test=mod_repro_costs$coef[[1]][2,1])
line_function_log_xy(SummarySpp[["mean"]]$repro_inv_per_seed,mod_repro_costs,3)
line_function_log_xy(SummarySpp[["mean"]]$seed_costs,mod_fixed_costs,1)

summary(mod_repro_costs)
summary(mod_fixed_costs)

plot(pollen_attract_costs ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",pch=16,col=col.spp(species),ylim=c(.005,5000))
points(prepollen_all_per_seed ~ embryo_endo_size, SummarySpp[["mean"]],pch=1,col=col.spp(species))
#points(prepollen_failure_costs ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",pch="-",col=col.spp(species))
mod_prepollen_all <- sma(prepollen_all_per_seed ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",method="SMA",slope.test=mod_repro_costs$coef[[1]][2,1])
mod_pollen_attract_costs <- sma(pollen_attract_costs ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",method="SMA",slope.test=mod_repro_costs$coef[[1]][2,1])
line_function_log_xy(SummarySpp[["mean"]]$prepollen_all_per_seed,mod_prepollen_all,3)
line_function_log_xy(SummarySpp[["mean"]]$pollen_attract_costs,mod_pollen_attract_costs,1)

summary(mod_prepollen_all)
summary(mod_pollen_attract_costs)
...
mod <- sma(seed_costs~prop_seed_costs,SummarySpp[["mean"]],method="SMA",log="y")
summary(mod)



#RE per seed unrelated to seedsize
mod <- sma(repro_inv_per_seed ~ embryo_endo_size, SummarySpp[["mean"]],method="SMA", log="xy",slope.test=1)
summary(mod)
...
mod <- sma(accessory_costs_using_ee ~ embryo_endo_size, data=subset(SummarySpp[["mean"]]),method="SMA", log="xy",slope.test=1)
summary(mod)
plot(accessory_costs_using_ee ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",pch=16,col=col.spp(species))

#total seed costs unrelated to seedsize
mod <- sma(seed_costs ~ embryo_endo_size, SummarySpp[["mean"]],method="SMA", log="xy",slope.test=1)
summary(mod)
plot(seed_costs ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",pch=16,col=col.spp(species))

#failure per seed unrelated to seedsize
mod <- sma(failure_per_seed ~ embryo_endo_size, data=subset(SummarySpp[["mean"]]),method="SMA", log="xy",slope.test=1)
summary(mod)
...
mod <- sma(scaled_seed_count ~ embryo_endo_size, data=subset(SummarySpp[["mean"]]),method="SMA", log="xy",slope.test=-1)
summary(mod)
...
mod <- sma(scaled_seed_count ~ seed_costs, data=subset(SummarySpp[["mean"]]),method="SMA", log="xy",slope.test=-1)
summary(mod)
plot(scaled_seed_count ~ seed_costs, SummarySpp[["mean"]],log="xy",pch=16,col=col.spp(species))


mod <- sma(prepollen_all_per_seed ~ embryo_endo_size, data=subset(SummarySpp[["mean"]]),method="SMA", log="xy",slope.test=1)
summary(mod)
plot(prepollen_failure_costs ~ embryo_endo_size, SummarySpp[["mean"]],log="xy",pch=16,col=col.spp(species),ylim=c(.02,10000))
points(pollen_attract_costs~ embryo_endo_size, SummarySpp[["mean"]],log="xy",pch=1,col=col.spp(species))
...
mod <- sma(propagule_inv ~ embryo_endo_size, SummarySpp[["mean"]],method="SMA", log="xy",slope.test=1)
summary(mod)
...
mod <- sma(propagule_inv ~ embryo_endo_size, data=subset(SummarySpp[["mean"]],species!="EPMI"),method="SMA", log="xy",slope.test=1)
summary(mod)
...
mod <- sma(repro_inv ~ embryo_endo_size, SummarySpp[["mean"]],method="SMA", log="xy",slope.test=1)
summary(mod)
...
mod <- sma(repro_inv ~ embryo_endo_size, data=subset(SummarySpp[["mean"]],species!="EPMI"),method="SMA", log="xy",slope.test=1)
summary(mod)
...
mod <- sma(total_weight_0 ~ embryo_endo_size, SummarySpp[["mean"]],method="SMA", log="xy",slope.test=1)
summary(mod)
...
plot(prop_prepollen_all~seedset,SummarySpp[["mean"]],col=col.spp(species),pch=16,log="x")

plot(prop_pollen_attract_costs~seedset,SummarySpp[["mean"]],col=col.spp(species),pch=16,log="")

mod <- sma(prop_prepollen_all~embryo_endo_size,SummaryInd,log="x",method="SMA")
summary(mod)

#Table 1 showing accessory cost values for the species
```{r}
acc_costs_spp <- dplyr::select(SummarySpp[["mean"]],species,embryo_endo_size,seedset,repro_inv_per_seed,prop_failure,prop_prepollen_vs_RE, prop_pack_disp_vs_RE,prop_embryo_endo_vs_RE,seed_costs,prop_pollen_attract_costs,prop_postpollen_costs,embryo_endo_size,pack_disp_costs,pollen_attract_costs,failure_inv,repro_inv,seed_count)
acc_costs_spp$species <- labels.spp.full()
acc_costs_spp_format <- acc_costs_spp
for (i in c("embryo_endo_size","seedset","repro_inv_per_seed","prop_failure","prop_prepollen_vs_RE","prop_pack_disp_vs_RE","prop_embryo_endo_vs_RE","seed_costs","prop_pollen_attract_costs","prop_postpollen_costs")) {
...
plot(repro_inv_per_seed ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),col=col.spp(species),pch=16,log="xy", ylim=c(.02,10000), xlim=c(.02,10000), ylab="total per seed accessory costs (mg/seed)",xlab="",cex=1.5)
y.error.bars(SummarySpp[["mean"]]$embryo_endo_size,SummarySpp[["mean"]]$repro_inv_per_seed,SummarySpp[["se"]]$accessory_costs)
slopes <- sma(repro_inv_per_seed ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1,method="SMA", log="xy")
...
slopes <- sma(seed_costs ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1,method="SMA", log="xy")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
...
plot(pollen_attract_costs ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),col=col.spp(species),pch=16,log="xy", ylim=c(.02,10000), ylab="prepollen success costs (mg/seed)",xlab="",cex=1.5)
y.error.bars(SummarySpp[["mean"]]$embryo_endo_size,SummarySpp[["mean"]]$pollen_attract_costs,SummarySpp[["se"]]$pollen_attract_costs)
slopes <- sma(pollen_attract_costs ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1,method="SMA", log="xy")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
acc_by_species <- dplyr::bind_rows(acc_by_species, dplyr::select(slopes$groupsummary,r2,pval,Slope,Slope_lowCI,Slope_highCI,Int,Int_lowCI,Int_highCI,Slope_test_p))
...
slopes <- sma(provisioning_costs ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1, log="xy",method="SMA")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
...
slopes <- sma(failure_per_seed ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1,method="SMA", log="xy")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
...
slopes <- sma(prepollen_all_per_seed ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1, log="xy",method="SMA")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
acc_by_species <- dplyr::bind_rows(acc_by_species, dplyr::select(slopes$groupsummary,r2,pval,Slope,Slope_lowCI,Slope_highCI,Int,Int_lowCI,Int_highCI,Slope_test_p))

plot(prepollen_failure_costs ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),col=col.spp(species),pch=16,log="xy", ylim=c(.02,10000), ylab="aborted pre-pollination costs (mg/seed)",xlab="",cex=1.5,xaxt="n")
y.error.bars(SummarySpp[["mean"]]$embryo_endo_size,SummarySpp[["mean"]]$prepollen_failure_costs,SummarySpp[["se"]]$prepollen_failure_costs)
slopes <- sma(prepollen_failure_costs ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1, log="xy",method="SMA")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
acc_by_species <- dplyr::bind_rows(acc_by_species, dplyr::select(slopes$groupsummary,r2,pval,Slope,Slope_lowCI,Slope_highCI,Int,Int_lowCI,Int_highCI,Slope_test_p))

plot(postpollen_aborted_costs ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),col=col.spp(species),pch=16,log="xy", ylim=c(.02,10000), ylab="aborted during provisioning costs (mg/seed)",xlab="",cex=1.5,xaxt="n")
y.error.bars(SummarySpp[["mean"]]$embryo_endo_size,SummarySpp[["mean"]]$postpollen_aborted_costs,SummarySpp[["se"]]$postpollen_aborted_costs)
slopes <- sma(postpollen_aborted_costs ~ embryo_endo_size,data=subset(SummarySpp[["mean"]]),slope.test=1, log="xy",method="SMA")
abline(slopes$groupsummary["Int"][[1]],slopes$groupsummary["Slope"][[1]])
abline(slopes$groupsummary["Int"][[1]],1,lty=2)
acc_by_species <- dplyr::bind_rows(acc_by_species, dplyr::select(slopes$groupsummary,r2,pval,Slope,Slope_lowCI,Slope_highCI,Int,Int_lowCI,Int_highCI,Slope_test_p))
...
plot((scaled_seed_count)~(embryo_endo_size),SummaryInd,pch=16,log="xy",col=col.spp(species),xlim=c(.002,500),ylim=c(1e-4,5000),yaxt="n",xaxt="n",ylab="")
...
mod_seed <- sma(scaled_seed_count~embryo_endo_size,data=subset(SummaryInd,scaled_seed_count!=0),log="xy",slope=-1,method="SMA")
...
line_function_log_xy(SummarySpp[["mean"]]$embryo_endo_size,mod_seed,1)
line_function_log_xy(SummarySpp[["mean"]]$embryo_endo_size,mod_ovule,2)
...
mod <- sma(seedset~embryo_endo_size,SummarySpp[["mean"]],log="xy", method="SMA")
...
plot(pollen_attract_costs~embryo_endo_size,SummarySpp[["mean"]],col=col.spp(species),pch=16,log="xy", yaxt="n",xaxt="n", ylim=c(.02,5000), xlim=c(.002,500), ylab="",xlab="",cex=1.5)
y.error.bars.2(SummarySpp[["mean"]]$embryo_endo_size,SummarySpp[["mean"]]$pollen_attract_costs,SummarySpp[["se"]]$pollen_attract_costs)
mod <- sma(pollen_attract_costs~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA")
...
y.error.bars.2(SummarySpp[["mean"]]$embryo_endo_size,SummarySpp[["mean"]]$postpollen_all_per_seed,SummarySpp[["se"]]$pollen_attract_costs)
mod <- sma(postpollen_all_per_seed~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA")
line_function_log_xy(SummarySpp[["mean"]]$embryo_endo_size,mod,1)
line_function_log_xy_zero(SummarySpp[["mean"]]$embryo_endo_size,mod,1)
axis(2, at=c(0.1,10,1000), labels=c(0.1,10,1000),cex.axis=1)
axis(1, at=c(0.01,1,100), labels=c(0.01,1,100),cex.axis=1)
...
#panel a
plot(scaled_seed_count~seed_costs,SummarySpp[["mean"]],pch=16,log="xy",col=venetian_red,xlim=c(.01,5000),ylim=c(5e-4,500),yaxt="n",xaxt="n",ylab="",xlab="",cex=1)
...
mod_seed <- sma(scaled_seed_count~seed_costs,data=SummarySpp[["mean"]],log="xy",slope=-1,method="SMA")
...
line_function_log_xy(SummarySpp[["mean"]]$seed_costs,mod_seed,1,col=venetian_red)
...
plot(prop_pollen_attract_costs~embryo_endo_size,SummarySpp[["mean"]],pch=16,log="x",col=cerulean,
     ylim=c(-0.1,1.1),xlim=c(.01,100),xlab="",ylab="",xaxt="n",yaxt="n")
points(prop_postpollen_costs~embryo_endo_size,SummarySpp[["mean"]],pch=16,col=venetian_red)
...
mod_prop_pollen_attract_costs <- sma(prop_pollen_attract_costs~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")
mod_prop_postpollen_costs <- sma(prop_postpollen_costs~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")

line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_pollen_attract_costs,1,col=cerulean)
line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_postpollen_costs,1,col=venetian_red)

#panel d - pollen-attraction proportions
plot(prop_prepollen_success~embryo_endo_size,SummarySpp[["mean"]],pch=16,log="x",col=cerulean,ylim=c(-.1,1.1),xlim=c(.01,100),xlab="",ylab="",xaxt="n",yaxt="n")
points(prop_prepollen_failure~embryo_endo_size,SummarySpp[["mean"]],pch=16,col=venetian_red)
...
mod_prop_prepollen_success <- sma(prop_prepollen_success~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")
mod_prop_prepollen_failure <- sma(prop_prepollen_failure~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")

line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_prepollen_success,1,col=cerulean)
line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_prepollen_failure,1,col=venetian_red)

#panel e - provisioning proportions
plot(prop_postpollen_success~embryo_endo_size,SummarySpp[["mean"]],pch=16,log="x",col=cerulean,ylim=c(-0.1,1.1),xlim=c(.01,100),xlab="",ylab="",xaxt="n",yaxt="n")
points(prop_postpollen_failure~embryo_endo_size,SummarySpp[["mean"]],pch=16,col=venetian_red)
...
mod_prop_postpollen_success <- sma(prop_postpollen_success~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")
mod_prop_postpollen_failure <- sma(prop_postpollen_failure~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")

line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_postpollen_success,1,col=cerulean)
line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_postpollen_failure,1,col=venetian_red)

#panel f - change in slope of "success costs"
plot(pollen_attract_costs~embryo_endo_size,SummarySpp[["mean"]],pch=16,log="xy",col=cerulean,xlim=c(.002,100),ylim=c(.01,20000),xlab="",ylab="",xaxt="n",yaxt="n")
points(provisioning_costs~embryo_endo_size,SummarySpp[["mean"]],pch=16,col=venetian_red)
...
mod_pollen_attract_costs <- sma(pollen_attract_costs~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA")
mod_provisioning_costs <- sma(provisioning_costs~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA",slope.test = mod_pollen_attract_costs$groupsummary$Slope_highCI)
line_function_log_xy(SummarySpp[["mean"]]$embryo_endo_size,mod_pollen_attract_costs,1,col=cerulean)
line_function_log_xy(SummarySpp[["mean"]]$embryo_endo_size,mod_provisioning_costs,1,col=venetian_red)
...
mod_prop_postpollen_costs <- sma(prop_postpollen_costs~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")
mod_prop_prepollen_success <- sma(prop_prepollen_success~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")
mod_prop_prepollen_success_SMA <- sma(prop_prepollen_success~embryo_endo_size,SummarySpp[["mean"]],log="x",method="SMA")
mod_prop_prepollen_failure <- sma(prop_prepollen_failure~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")
mod_prop_postpollen_success <- sma(prop_postpollen_success~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")
mod_prop_postpollen_failure <- sma(prop_postpollen_failure~embryo_endo_size,SummarySpp[["mean"]],log="x",method="OLS")
...
#temp <- dplyr::select(mod_prop_prepollen_failure$groupsummary,r2,pval,Slope,Slope_lowCI,Slope_highCI,Int,Int_lowCI,Int_highCI)
...
points(provisioning_costs~embryo_endo_size,SummarySpp[["mean"]],col=col.spp(species),pch=21,cex=1.5)
y.error.bars.2(SummarySpp[["mean"]]$embryo_endo_size,SummarySpp[["mean"]]$provisioning_costs,SummarySpp[["se"]]$provisioning_costs)

axis(2, at=c(0.1,10,1000), labels=c(0.1,10,1000),cex.axis=1)
axis(1, at=c(0.01,1,100), labels=c(0.01,1,100),cex.axis=1)
mtext("costs (mg/ovule)",2,line=2.3)

mod_prepollen <- sma(pollen_attract_costs~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA")
mod_provision <- sma(postpollen_all_per_seed~embryo_endo_size,SummarySpp[["mean"]],log="xy",method="SMA",slope.test=mod_prepollen$groupsummary["Slope"][[1]])


line_function_log_xy(SummarySpp[["mean"]]$embryo_endo_size,mod_prepollen,1)
line_function_log_xy(SummarySpp[["mean"]]$embryo_endo_size,mod_provision,2)

legend("topright",legend=c("pollen_attraction","provisioning"),col=c("black","black"),pch=c(16,21),bty="n")
extra.top.left.logxy("c",2,1.2)

plot(prop_pollen_attract_costs~embryo_endo_size,SummarySpp[["mean"]],col=col.spp(species),pch=16,log="x", yaxt="n",xaxt="n", ylim=c(0,1), xlim=c(.002,500), ylab="",xlab="",cex=1.5)
points(prop_prepollen_all~embryo_endo_size,SummarySpp[["mean"]],col=col.spp(species),pch=1,cex=1.5)
axis(2, at=c(0,.5,1), labels=c(0,0.5,1.0),cex.axis=1)
axis(1, at=c(0.01,1,100), labels=c(0.01,1,100),cex.axis=1)
extra.top.left.logx("d",2,1.2)

mod_prop_pollen_attract_costs <- sma(prop_pollen_attract_costs~embryo_endo_size,SummarySpp[["mean"]],log="x",method="SMA",slope.test=0)
mod_prop_prepollen_all <- sma(prop_prepollen_all~embryo_endo_size,SummarySpp[["mean"]],log="x",method="SMA",slope.test=0)

line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_pollen_attract_costs,1)

summary(mod_prop_pollen_attract_costs)
summary(mod_prop_prepollen_all)


plot(prop_postpollen_success~embryo_endo_size,SummarySpp[["mean"]],col=col.spp(species),pch=16,log="x", yaxt="n",xaxt="n", ylim=c(0,1), xlim=c(.002,500), ylab="",xlab="",cex=1.5)
points(prop_prepollen_success~embryo_endo_size,SummarySpp[["mean"]],col=col.spp(species),pch=1,cex=1.5)
axis(2, at=c(0,.5,1), labels=c(0,0.5,1.0),cex.axis=1)
axis(1, at=c(0.01,1,100), labels=c(0.01,1,100),cex.axis=1)
extra.top.left.logx("d",2,1.2)

mod_prop_postpollen_success <- sma(prop_postpollen_success~embryo_endo_size,SummarySpp[["mean"]],log="x",method="SMA")
mod_prop_prepollen_success <- sma(prop_prepollen_success~embryo_endo_size,SummarySpp[["mean"]],log="x",method="SMA")

line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_postpollen_success,1)
line_function_log_x(SummarySpp[["mean"]]$embryo_endo_size,mod_prop_prepollen_success,3)
...
mod <- sma(seed_size~total_weight_0,data=subset(SummarySpp[["mean"]]),log="xy",method="SMA")
summary(mod)
```
...
mod <-sma(scaled_repro_inv~seed_size,SummarySpp[["mean"]],log="xy",method="SMA")
summary(mod)
```
