...
invest <- subset(InvestmentByPart,species=="COER"&part=="flower_petals")
invest

invest_ind <- subset(InvestmentByPart,individual=="BOLE_154")

ind <- subset(SummaryInd, species=="COER"&seed_count>0)
