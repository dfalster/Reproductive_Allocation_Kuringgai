...
#fixed = BOLE, GRBU, PUTU,

#nearly fixed = EPMI, PELA, LEES
...
invest_ind <- subset(InvestmentByPart,individual=="PUTU_152")

ind <- subset(SummaryInd, species=="GRBU"&seed_count>0)
check3 <- select(ind,individual,prepollen_costs,seed_early_costs,prepollen_costs,pack_disp_costs,pack_disp_early_costs,propagule_per_seed,seed_costs)
