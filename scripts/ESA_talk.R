...
for(spp in names(data)) {
  ...
  if(spp=="PILI") {
    ...
    polygon(x=c(1.4,2.4,5,7,7,1.4),y=c(data[[spp]]$repro_prop_all_leaf[1],data[[spp]]$repro_prop_all_leaf[2],data[[spp]]$repro_prop_all_leaf[3],data[[spp]]$repro_prop_all_leaf[4],
                                       0,0),col="coral3",density=NA)
  ...
  if(spp=="PHPH") {
    ...
    polygon(x=c(2.4,5,7,9,32,32,2.4),y=c(data[[spp]]$repro_prop_all_leaf[1],data[[spp]]$repro_prop_all_leaf[2],data[[spp]]$repro_prop_all_leaf[3],data[[spp]]$repro_prop_all_leaf[4],
                                         data[[spp]]$repro_prop_all_leaf[5],0,0),col="coral3",density=NA)
    text(20,data[[spp]]$repro_prop_all_leaf[5]*.7,"reproductive")
  ...
  if(spp=="BOLE"|spp=="COER"|spp=="HEPU"|spp=="GRSP") {
    ...
    polygon(x=c(1.4,2.4,5,7,9,9,1.4),y=c(data[[spp]]$prop_leaf_expand[1],data[[spp]]$prop_leaf_expand[2],data[[spp]]$prop_leaf_expand[3],data[[spp]]$prop_leaf_expand[4],
                                         data[[spp]]$prop_leaf_expand[5],0,0),col="darkseagreen2",density=NA)
    polygon(x=c(1.4,2.4,5,7,9,9,1.4),y=c(data[[spp]]$repro_prop_all_leaf[1],data[[spp]]$repro_prop_all_leaf[2],data[[spp]]$repro_prop_all_leaf[3],data[[spp]]$repro_prop_all_leaf[4],
                                         data[[spp]]$repro_prop_all_leaf[5],0,0),col="coral3",density=NA)
    text(8,data[[spp]]$repro_prop_all_leaf[5]*.4,"reproductive",adj=1)
  ...
  if(spp=="BAER"|spp=="EPMI"|spp=="GRBU"|spp=="HATE"|spp=="PELA"|spp=="PUTU"|spp=="LEES"|spp=="PEPU") {
    ...
    text(20,data[[spp]]$repro_prop_all_leaf[6]*.4,"reproductive")
...
data <- dplyr::select(SummarySppAge[["mean"]],species,age,repro_inv,growth_leaf,leaf_replacement,leaf_shed,all_leaf_and_repro_inv,growth_leaf_pos,repro_prop_all_leaf,leaf_shed_prop_surplus)
...
for(spp in c("BOLE","PILI","HEPU","COER","GRBU","GRSP","GRSP","GRSP","EPMI","LEES","PHPH","PUTU","HATE","BAER","PELA","PEPU")) {
  ...
  plot(repro_prop_all_leaf~age,data[[spp]],pch=16,log="x",ylim=c(0.04,0.96),xlim=c(1.06*1.4,0.94*32),col="white")
...
par(mfcol=c(1,4), cex=1, omi=c(.5,.5,.1,.1), mai=c(0.2,.25,.01,0.02))  
...
for(spp in c("EPMI")) {
  ...
  polygon(x=c(1.4,2.4,5,7,9,32,32,1.4),y=c(data[[spp]]$seed_prop_all[1],data[[spp]]$seed_prop_all[2],
                                           ...
                                           data[[spp]]$seed_prop_all[5],data[[spp]]$seed_prop_all[6],0,0),col="coral3",density=NA) 
  
  plot(RA_seed~age,data[[spp]],pch=16,log="x",ylim=c(0.04,0.96),xlim=c(1.06*1.4,0.94*32),col="white",las=1,xaxs="i",ylab="",yaxt="n")
  polygon(x=c(1.4,32,32,1.4),y=c(1,1,0,0),col="gray67",density=NA)
  polygon(x=c(1.4,2.4,5,7,9,32,32,1.4),y=c(data[[spp]]$prop_repro[1],data[[spp]]$prop_repro[2],data[[spp]]$prop_repro[3],
                                           data[[spp]]$prop_repro[4],data[[spp]]$prop_repro[5],data[[spp]]$prop_repro[6],0,0),col="coral3",density=NA)
