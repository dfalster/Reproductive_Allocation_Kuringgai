...
plot(repro_inv~jitter(growth_leaf_no_neg_values), subset(SummaryInd), log="xy", col=col.spp(species),pch=16,xlim=c(1,1000000),ylim=c(1,1000000),
...
plot(repro_inv~growth_leaf_no_neg_values, subset(SummaryInd), log="xy", col=col.age(age),pch=16,xlim=c(1,1000000),ylim=c(1,1000000),
     xlab="",ylab="",cex=0.8,xaxt="n",yaxt="n")
axis(1, at=c(1,100,10000,1000000), labels=c(1,100,10000,"1000000"),cex.axis=0.9)
axis(2, at=c(1,100,10000,1000000), labels=c(1,100,10000,"1000000"),cex.axis=0.9)
#legend("topleft",legend=labels.spp(),col=col.spp(),pch=16, cex=.6,bty="n")
