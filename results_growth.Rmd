...
```{r, echo=FALSE,message=FALSE,fig.width=14, fig.height=14}
par(mfrow=c(2,2), cex=1, omi=c(.5,0.3,.1,0.2), mai=c(.5,1,.6,0.2)) 
plot(growth_inv ~ LMA,data=subset(SummarySppAge,age==1.4),log="xy",col=col.age(),pch=16,cex=1,xlab="",ylab="",main="Seedlings")
...
plot(growth_inv ~ LMA,data=subset(SummarySppAge,age>3),log="xy",col=col.age(),pch=16,cex=1,xlab="",ylab="",main="Adults")
...
plot(growth_inv ~ LMA,data=subset(SummarySppAge,age>3&species!="HATE"),log="xy",col=col.age(),pch=16,cex=1,xlab="",ylab="",main="Adults")
