...
plot(growth_inv ~ maxH,data=subset(SummarySppAge,age==1.4),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Seedlings")
...
plot(growth_inv ~ maxH,data=subset(SummarySppAge,age>3),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Adults")
...
```{r, echo=FALSE,message=FALSE,fig.width=14, fig.height=14}
par(mfrow=c(2,2), cex=1, omi=c(.5,0.3,.1,0.2), mai=c(.5,1,.6,0.2)) 
plot(growth_inv ~ WD,data=subset(SummarySppAge,age==1.4),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Seedlings")
text(growth_inv ~ WD, data=subset(SummarySppAge,age==1.4), labels=species, pos=1, offset=-1.1, cex=0.7,col="blue")
mod <- lm(growth_inv ~ WD, data=subset(SummarySppAge,age==1.4))
words.bottom.left.logxy(mod)

plot(growth_inv ~ WD,data=subset(SummarySppAge,age==2.4),log="xy",col="gold1",pch=16,cex=1,xlab="",ylab="",main="Saplings")
text(growth_inv ~ WD, data=subset(SummarySppAge,age==2.4), labels=species, pos=1, offset=-1.1, cex=0.7,col="blue")
mod <- lm(growth_inv ~ WD, data=subset(SummarySppAge,age==2.4))
words.bottom.left.logxy(mod)
legend("topright",col=col.age,labels.age(),pch=16, bty="n")

plot(growth_inv ~ WD,data=subset(SummarySppAge,age>3),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Adults")
text(growth_inv ~ WD, data=subset(SummarySppAge,age==5), labels=species, pos=1, offset=-1.1, cex=0.6,col="blue")
mod <- lm(growth_inv ~ WD, data=subset(SummarySppAge,age>3))
words.bottom.left.logxy(mod)
...
plot(RGR ~ WD,data=subset(SummarySppAge,age==1.4),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Seedlings")
text(RGR ~ WD, data=subset(SummarySppAge,age==1.4), labels=species, pos=1, offset=-1.1, cex=0.7,col="blue")
mod <- lm(RGR ~ WD, data=subset(SummarySppAge,age==1.4))
words.bottom.right.logxy(mod)

plot(RGR ~ WD,data=subset(SummarySppAge,age==2.4),log="xy",col="gold1",pch=16,cex=1,xlab="",ylab="",main="Saplings")
text(RGR ~ WD, data=subset(SummarySppAge,age==2.4), labels=species, pos=1, offset=-1.1, cex=0.7,col="blue")
mod <- lm(RGR ~ WD, data=subset(SummarySppAge,age==2.4))
words.bottom.right.logxy(mod)
legend("topright",col=col.age,labels.age(),pch=16, bty="n")
...
```{r, echo=FALSE,message=FALSE,fig.width=14, fig.height=14}
par(mfrow=c(2,2), cex=1, omi=c(.5,0.3,.1,0.2), mai=c(.5,1,.6,0.2)) 
plot(growth_inv ~ leaf_area,data=subset(SummarySppAge,age==1.4),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Seedlings",ylim=c(100,50000))
...
plot(growth_inv ~ leaf_area,data=subset(SummarySppAge,age>3),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Adults",ylim=c(100,1000000))
...
```{r, echo=FALSE,message=FALSE,fig.width=14, fig.height=14}
par(mfrow=c(2,2), cex=1, omi=c(.5,0.3,.1,0.2), mai=c(.5,1,.6,0.2)) 
plot(growth_inv ~ LMA,data=subset(SummarySppAge,age==1.4),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Seedlings")
text(growth_inv ~ LMA, data=subset(SummarySppAge,age==1.4), labels=species, pos=1, offset=-1.1, cex=0.7,col="blue")
mod <- lm(growth_inv ~ LMA, data=subset(SummarySppAge,age==1.4))
words.bottom.right.logxy(mod)

plot(growth_inv ~ LMA,data=subset(SummarySppAge,age==2.4),log="xy",col="gold1",pch=16,cex=1,xlab="",ylab="",main="Saplings")
text(growth_inv ~ LMA, data=subset(SummarySppAge,age==2.4), labels=species, pos=1, offset=-1.1, cex=0.7,col="blue")
mod <- lm(growth_inv ~ LMA, data=subset(SummarySppAge,age==2.4))
words.bottom.right.logxy(mod)
legend("topright",col=col.age,labels.age(),pch=16, bty="n")

plot(growth_inv ~ LMA,data=subset(SummarySppAge,age>3),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Adults")
text(growth_inv ~ LMA, data=subset(SummarySppAge,age>3), labels=species, pos=1, offset=-1.1, cex=0.6,col="blue")
mod <- lm(growth_inv ~ LMA, data=subset(SummarySppAge,age>3))
words.bottom.right.logxy(mod)

plot(growth_inv ~ LMA,data=subset(SummarySppAge,age>3&species!="HATE"),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Adults")
text(growth_inv ~ LMA, data=subset(SummarySppAge,age>3&species!="HATE"), labels=species, pos=1, offset=-1.1, cex=0.6,col="blue")
mod <- lm(growth_inv ~ LMA, data=subset(SummarySppAge,age>3&species!="HATE"))
words.bottom.right.logxy(mod)
...
```{r, echo=FALSE,message=FALSE,fig.width=14, fig.height=14}
par(mfrow=c(2,2), cex=1, omi=c(.5,0.3,.1,0.2), mai=c(.5,1,.6,0.2))
plot(growth_inv ~ LL_death,data=subset(SummarySppAge,age==1.4),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Seedlings")
text(growth_inv ~ LL_death, data=subset(SummarySppAge,age==1.4), labels=species, pos=1, offset=-1.1, cex=0.7,col="blue")
mod <- lm(log(LL_death)~log(growth_inv), data=subset(SummarySppAge,age==1.4))
words.bottom.right.logxy(mod)

plot(growth_inv ~ LL_death,data=subset(SummarySppAge,age==2.4),log="xy",col="gold1",pch=16,cex=1,xlab="",ylab="",main="Saplings")
text(growth_inv ~ LL_death, data=subset(SummarySppAge,age==2.4), labels=species, pos=1, offset=-1.1, cex=0.7,col="blue")
mod <- lm(growth_inv ~ LL_death, data=subset(SummarySppAge,age==2.4))
words.bottom.right.logxy(mod)

plot(growth_inv ~ LL_death,data=subset(SummarySppAge,age>3),log="xy",col=col.age(age),pch=16,cex=1,xlab="",ylab="",main="Adults")
text(growth_inv ~ LL_death, data=subset(SummarySppAge,age>3), labels=species, pos=1, offset=-1.1, cex=0.6,col="blue")
mod <- lm(growth_inv ~ LL_death, data=subset(SummarySppAge,age>3))
legend("topright",col=col.age,labels.age(),pch=16, bty="n")
words.bottom.right.logxy(mod)
...
SummaryIndPCA <- SummaryInd %>%
  ...
  select(prop_maxH,height,maxH,WD,LMA,seed_size,growth_leaf,
...
mean1 <- PCA_by_species$PC1_scale
...
* PC4 is now the axis that separates LMA and maxH vs. WD, with variables like maxH pulling toward all the "big size" arrows
...
mod <- lm(RGR~asin(sqrt(RA))+prop_maxH+log(propagule_inv+1)+log(accessory_inv+1)+log(total_weight)+log(repro_all_count+1)+WD+LMA+maxH,SummaryInd)
anova(mod)
glance(mod)[1]
```

* another of the interesting pattern is that the increase in shoot area of leaders is correlated with maxH and seed_size (and opposite WD) and somewhat offset from whole plant growth measures and whole plant size measures  
* seed_size removed, because no additional explanatory power after WD and maxH included


```{r, echo=FALSE,message=FALSE}
mod <- lm(log(growth_shoot_area)~log(maxH)+WD+log(growth_stem_area)+log(total_weight)+RGR+asin(sqrt(RA))+LMA,SummaryInd)
anova(mod)
glance(mod)
```
...
```{r, echo=FALSE,message=FALSE,fig.width=14, fig.height=14}
par(mfrow=c(2,2), cex=1, omi=c(.5,0.3,.1,0.2), mai=c(1.1,1,.6,0.2))
plot(WD~maxH,SummarySpp[["mean"]], log="x",col=col.spp(species),pch=16)
mod <- lm(log(maxH)~WD,SummaryInd)
words.bottom.left.logx(mod)

plot(WD~maxH,data=subset(SummarySpp[["mean"]],species!="PUTU"&species!="PHPH"), log="x",col=col.spp(species),pch=16)
mod <- lm(log(maxH)~WD,data=subset(SummarySpp[["mean"]],species!="PUTU"&species!="PHPH"))
words.bottom.left.logx(mod)

plot(seedset~total_weight,SummarySpp[["mean"]], log="x",col=col.spp(species),pch=16)
mod <- lm(log(total_weight) ~ (seedset),SummarySpp[["mean"]])
words.bottom.left.logx(mod)

plot(seedset~maxH,SummarySpp[["mean"]], log="x",col=col.spp(species),pch=16)
