...
plot((total_weight~PropH), SummaryInd, col=col.spp[as.factor(species)],pch=16,log="y")
...
plot(total_leaf_weight~total_weight,SummaryInd, log="xy",col=col.spp[as.factor(species)], pch=16, cex=0.8)
...
plot((change_shoot_area/10000) ~ dia,data=subset(SummaryInd), log="xy",col=col.spp[as.factor(species)], pch=16,ylim=c(0.01,500),cex=.7)
points((change_basal_area) ~ dia,data=subset(SummaryInd), log="xy",col=col.spp[as.factor(species)], pch=1)

plot((change_shoot_area/10000) ~ dia,data=subset(SummaryInd), log="xy",col=col.age[as.factor(age)], pch=16,ylim=c(0.01,500),cex=.7)
points((change_basal_area) ~ dia,data=subset(SummaryInd), log="xy",col=col.age[as.factor(age)], pch=1)
