...
plot((FinalWeight~StartBasalDiamAv), SummaryInd, col=col.spp[as.factor(species)],pch=16,log="xy")
...
###PropH by age
- Confirming that species get taller as they get older  
- Obviously true for most species, but some (i.e. PILI, somewhat BOLE, HEPU) they reach their "maxH" within a few years and then the relationship is mostly flat. These are of course also the species which are shorter lived and have high levels of early reproduction  
