...
plot(choosiness2~prop_pollen_attract_vs_all_repro,SummarySpp[["mean"]],log="xy",col=cerulean,pch=16,xlim=c(.002,.3),ylim=c(3,800),yaxt="n",cex=1,ylab="",xlab="",xaxt="n")
...
mod_choosy2 <- sma(choosiness2~prop_pollen_attract_vs_all_repro,data=subset(SummarySpp[["mean"]],species!="EPMI"),log="xy",slope=-1,method="SMA")
