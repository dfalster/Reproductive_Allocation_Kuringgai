...
```{r}
png("ms/Accessory/output/Figure01b&c&d_predictions.png", height=3.6, width=9, units="in", res=300)
par(mfrow=c(1,3), cex=1, omi=c(.1,.1,.05,.2), mai=c(.8,.8,.6,.05))
...
mtext(text="seed count,",side=2,line=1.3,outer=FALSE,cex=0.8)
mtext(text="scaled to plant size",side=2,line=0.4,outer=FALSE,cex=0.8)
mtext(text="reproductive costs",side=1,line=0.3,outer=FALSE,cex=0.8)
mtext(text="(mg/seed)",side=1,line=1.2,outer=FALSE,cex=0.8)
...
mtext(text="mature ovules count,",side=2,line=1.3,outer=FALSE,cex=0.8)
mtext(text="scaled to plant size",side=2,line=0.4,outer=FALSE,cex=0.8)
mtext(text="pollen attraction costs",side=1,line=0.3,outer=FALSE,cex=0.8)
mtext(text="(mg/seed)",side=1,line=1.2,outer=FALSE,cex=0.8)
...
mtext(text="choosiness",side=2,line=1.3,outer=FALSE,cex=0.8)
mtext(text="(ovule:seed)",side=2,line=0.4,outer=FALSE,cex=0.8)
mtext(text="pollen attraction costs,",side=1,line=0.3,outer=FALSE,cex=0.8)
mtext(text="scaled to plant size",side=1,line=1.2,outer=FALSE,cex=0.8)
mtext(text="(mg/seed)",side=1,line=2.1,outer=FALSE,cex=0.8)
