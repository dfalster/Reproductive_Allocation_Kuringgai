...
mtext(text="b.  Trade-off 1:",side=3,outer=FALSE,adj=0,line=1.6)
...
axis(1, at=c(0,1),labels=c("lower","higher"),cex.axis=1)
axis(2, at=c(0,1),labels=c("lower","higher"),cex.axis=1,las=2)
mtext(text="c.  Trade-off 2.",side=3,outer=FALSE,adj=0,line=1.6)
...
axis(1, at=c(0,1),labels=c("lower","higher"),cex.axis=1)
axis(2, at=c(0,1),labels=c("lower","higher"),cex.axis=1,las=2)
mtext(text="d.  Trade-off 3.",side=3,outer=FALSE,adj=0,line=1.6)
