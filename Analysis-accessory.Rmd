...
```{r}
png("ms/Accessory/output/Figure_SXX_RE_RA_size_age_patterns.png", height=10, width=10, units="in", res=300)
...
write.csv(results, file="ms/Accessory/output/Table05a_accessory_vs_all_repro.csv",row.names=FALSE)
...
write.csv(results, file="ms/Accessory/output/Table05b_accessory_vs_total_weight.csv",row.names=FALSE)
...
write.csv(results, file="ms/Accessory/output/Table05c_accessory_vs_age.csv",row.names=FALSE)
dev.off()
```
