...
#for(i in 1:14) {
#arrows(i,tmp$PerPropagule_mean[i]+tmp$PerPropagule_se[i],i,tmp$PerPropagule_mean[i]-tmp$PerPropagule_se[i],code=3,angle=90, length=0.1)}


#barplot(height=test$PerPropagule_mean, names=test$species,cex.axis=.8,ylim=c(0,.25),cex.names=.8)
#xv <- barplot(height=test$PerPropagule_mean, names=test$species,cex.axis=.8,ylim=c(0,.25),cex.names=.8)
#xv

#points((PerPropagule_mean+PerPropagule_se)~species,test,pch=25)
#points((PerPropagule_mean-PerPropagule_se)~species,test,pch=24)
