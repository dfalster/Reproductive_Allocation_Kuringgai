...
plot(fruit_weight~total_weight,data=subset(SummaryInd,fruit_weight>0), log="xy",col=col.spp[as.factor(species)], pch=16, ylab="Fruit investment (mg)",xlim=c(100,2000000),xlab="")
words.bottom.right.logxy(mod)
