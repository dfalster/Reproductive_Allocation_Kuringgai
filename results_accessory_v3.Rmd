...
### Comparing "per successful seed" and "proportion reproductive investment" accessory cost calculations 
  ...
  - cross-species variation is accentuated in plots calculated as "per successful seed" (vs. those with proportional accessory costs), because the species that have more seeds (lower proportional accessory costs), also have higher seedset
    ...
    - And that species with greater prepollination investment have higher accessory costs (since this is nearly the complement to propagule investment)
...
###Seedset by age
* Replotting the seedset data by age, showing that the correlation between seedset and accessory costs is not primarily age related
* At most, there are most "old" plants with very low seedset 
```{r, echo=FALSE,message=FALSE,fig.width=6, fig.height=6}
par(mfrow=c(1,1), cex=1, omi=c(0.6,0.3,0.3,0.3), mai=c(0.8,1,0.3,0.3))  
...
* If they shifted their proportional investment, there would be a relationship between RA and the proportional investment in 1 (or more) of the 5 reproductive energy pools. If they do not shift their proportional investment, all 5 would have no relationship.
    ** Only "proportional energy to pre-pollination aborted tissues" shows a significant decline with increasing RA - and it has a very convincing decline. Since no other pool shows an increase in proportional investment, that extra energy must be distributed fairly randomly across other pools

* Simultaneously, all tissue pools should show a positive relationship between actual investment amounts (mg) and RA
  ** Indeed, all pools increase with increasing RA, although only "pre-pollination successful tissues" and "energy to propagules" have a convincing r-squared value (across all species)
