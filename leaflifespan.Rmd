...
-Similarly, have separate file where all teh summary calculations occur
...
SummaryInd$change_basal_diam <- SummaryInd$growth_stem_diam
SummaryInd$change_shoot_area <- (3.14*((SummaryInd$d_end/2)^2)) - (3.14*((SummaryInd$d_start/2)^2))
SummaryInd$change_basal_area <- SummaryInd$growth_stem_area
...
investment_summary <- investment %>%
  group_by(species, age) %>%
  summarise_each(funs(mean, se, length), GrowthInv, total_weight, dia, TotalInvestment, RA)
...
plot(new_length ~ age,SummaryInd,col=col.spp[specie],log="xy")
...
```{r, echo=FALSE,results='hide', message=FALSE}
plot(total_leaf_weight~total_weight,SummaryInd, log="xy",col=col.age[as.factor(age)], pch=16, cex=0.8)
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
mod <-lm(total_weight~total_leaf_weight+age+species,SummaryInd)
summary(mod)

plot_LeafWeight <- function(spp) {
  plot(total_leaf_weight~total_weight,data=subset(SummaryInd,species==spp), xlab="total weight (mg)", ylab ="leaf weight (mg)", log="xy",col=col.age[as.factor(age)], pch=16,     cex=0.8,main=labels.spp[spp])
  legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
  mod <-lm(total_weight~total_leaf_weight+age,data=subset(SummaryInd,species==spp))
  abline(mod)
  summary(mod)
}
...
plot(leafArea~total_weight,SummaryInd, log="xy",col=col.age[as.factor(age)], pch=16, cex=0.8)
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
mod <-lm(total_weight~leafArea+age+species,SummaryInd)
summary(mod)

plot_LeafArea <- function(spp) {
  plot(leafArea~total_weight,data=subset(SummaryInd,species==spp), xlab="total weight (mg)", ylab ="leaf weight (mg)", log="xy",col=col.age[as.factor(age)], pch=16,     cex=0.8,main=labels.spp[spp])
  legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
  mod <-lm(total_weight~leafArea+age,data=subset(SummaryInd,species==spp))
  abline(mod)
  summary(mod)
}
...
plot(new_length~total_weight,SummaryInd, log="xy",col=col.age[as.factor(age)], pch=16, cex=0.8)
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
mod <-lm(total_weight~new_length+age+species,SummaryInd)
summary(mod)

plot_LeaderExtension <- function(spp) {
  plot(new_length~total_weight,data=subset(SummaryInd,species==spp), xlab="total weight (mg)", ylab ="leaf weight (mg)", log="xy",col=col.age[as.factor(age)], pch=16,     cex=0.8,main=labels.spp[spp])
  legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
  mod <-lm(total_weight~new_length+age,data=subset(SummaryInd,species==spp))
  abline(mod)
  summary(mod)
}
...
```{r, echo=FALSE,results='hide', message=FALSE}
plot(change_shoot_area~new_length,SummaryInd, log="xy",col=col.age[as.factor(age)], pch=16, cex=.8, xlab="shoot extension (mm)", ylab="increased shoot cross sectional area",main="How well do growth at the shoot level and whole plant level match?")
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)

plot(change_shoot_area~new_length,SummaryInd, log="xy",col=col.spp[as.factor(species)], pch=16, cex=.8, xlab="shoot extension (mm)", ylab="increased shoot cross sectional area",main="How well do growth at the shoot level and whole plant level match?")
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
...
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
mod <- lm(change_shoot_area~change_basal_area+age,subset(SummaryInd,age>3))
summary(mod)


plot(change_shoot_area~change_basal_area,SummaryInd, log="xy",col=col.spp[as.factor(species)], pch=16, cex=.8,xlab="change in basal stem area",ylab="change in shoot area")
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
...
#Plots indicating there is a fundamental problem with leaf lifespan measurements
```{r, echo=FALSE,results='hide', message=FALSE}
plot(LL_death ~ LL_birth, data=subset(SummaryInd,LL_bd>0&LL_bd<5&LL_death<5&age>2.4))
mod <- lm(LL_death ~ LL_birth, data=subset(SummaryInd,LL_bd>0&LL_bd<5&LL_death<5&age>2.4&LL_birth!=Inf))
summary(mod)

plot(LL_death ~ LL_bd, data=subset(SummaryInd,LL_bd>0&LL_bd<5&LL_death<5&age>2.4))
mod <- lm(LL_death ~ LL_bd, data=subset(SummaryInd,LL_bd>0&LL_bd<5&LL_death<5&age>2.4))
summary(mod)
```
...
```{r, echo=FALSE,results='hide', message=FALSE}
plot(GrowthInv_mean ~ LMA_mean,data=subset(SummarySppAge,age==1.4),log="xy",col=col.age[as.factor(age)],pch=16,cex=1,xlab="LMA",ylab="growth investment (mg per year)",main="Seedlings")
...
plot(GrowthInv_mean ~ LMA_mean,data=subset(SummarySppAge,age==2.4),log="xy",col=col.age[as.factor(age)],pch=16,cex=1,xlab="LMA",ylab="growth investment (mg per year)",main="Saplings")
...
plot(GrowthInv_mean ~ LMA_mean,data=subset(SummarySppAge,age>3),log="xy",col=col.age[as.factor(age)],pch=16,cex=1.2,xlab="LMA",ylab="growth investment (mg per year)",main="Adults")
...
plot(GrowthInv_mean ~ WD_mean,data=subset(SummarySppAge,age>3),log="xy",col=col.age3[as.factor(age)],pch=16,cex=.7)
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
...
plot(GrowthInv_mean ~ seed_size,data=subset(SummarySppAge,age>.5),log="xy",col=col.age[as.factor(age)],pch=16,cex=1)
...
plot(GrowthInv_mean ~ maxH_spp,data=subset(SummarySppAge,age==2.4),log="xy",col=col.age[as.factor(age)],pch=16,cex=.7)
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
mod<-lm(maxH_spp~GrowthInv_mean,data=subset(SummarySppAge,age==2.4))
summary(mod)

plot(GrowthInv_mean ~ maxH_spp,data=subset(SummarySppAge,age>3),log="xy",col=col.age[as.factor(age)],pch=16,cex=1.2)
legend("bottomright",col=col.age, labels.age, pch=16, cex=1)
