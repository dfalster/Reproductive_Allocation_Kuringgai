...
- "leader" diameter
- total biomass
- leaf mass (calculations not yet done)
- leaf area (calculations not yet done)
...
#TO DO: REMOVE DUPLICATE COLUMNS FOR AGE and SPECIES
...
plot(LL_birth_mean ~ LMA_mean, data=subset(SummarySppAge,age==7), xlab="LMA", ylab="leaf lifespan (years)", main="leaf lifespan versus LMA", las=1, pch=16)
text(LL_birth_mean ~ LMA_mean, data=subset(SummarySppAge,age==7), labels=species, pos=1, offset=-0.9, cex=0.9,col="blue")
text(LL_birth_mean ~ LMA_mean, data=subset(SummarySppAge,age==7 & species=="HATE"), labels=species, pos=1, offset=-0.9, cex=0.9,col="red")
mod <- lm(LL_birth_mean ~ LMA_mean, data=subset(SummarySppAge,species!="HATE" & age==7))
summary(mod)
abline(mod)
```
