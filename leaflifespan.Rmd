...
accessory$PrePol_S[which(is.na(accessory$PrePol_S))] <- 0
accessory$Total= (accessory$PrePol_A + accessory$PrePol_S + accessory$PostPol_A + accessory$PD + accessory$Prop)
