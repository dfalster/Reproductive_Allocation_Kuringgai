...
SummarySppAge[["mean"]]$leaf_shed_mean <- SummaryInd %>%
        group_by(species,age) %>%
        summarise(mean(leaf_shed_mean))

SummarySppAge[["mean"]]$leaf_replacement_mean <- SummaryInd %>%
        group_by(species,age) %>%
...
data_ind <- select(SummaryInd,species,individual,age, LL_death,height_0,leaf_shed,leaf_weight_0,propagule_inv,ovule_count,
