...
plot(RA_mean~WD_mean,data=subset(SummarySpp,RA_mean>0), col=col.spp(species),pch=16,log="y",ylab="")
mod <- lm(WD_mean~asin(sqrt(RA_mean)),SummarySpp)
words.bottom.left.logy(mod)
plot(RA_mean~seed_size, SummarySpp, col=col.spp(species),pch=16,log="xy",ylab="")
...
plot(RA_mean~LMA_mean, SummarySpp, col=col.spp(species),pch=16,log="xy",ylab="")
mod <- lm(log(LMA_mean)~asin(sqrt(RA_mean)), data=subset(SummarySpp,RA_mean>0))
words.top.right.logxy(mod)
plot(RA_mean~maxH, SummarySpp, col=col.spp(species),pch=16,log="xy",ylab="")
...
```{r, echo=FALSE,message=FALSE,fig.width=14, fig.height=14}
par(mfrow=c(2,2), cex=1, omi=c(.6,0.3,.1,0.2), mai=c(1.1,1,.5,0.2))
plot(maxH~WD_mean,data=subset(SummarySpp), col=col.spp(species),pch=16,log="y",ylab="")
mod <- lm(mature_RA_mean~asin(sqrt(mature_RA_mean)),data=subset(SummarySpp,species!="BAER"))
words.bottom.left.logy(mod)
plot(mature_RA_mean~seed_size, data=subset(SummarySpp), col=col.spp(species),pch=16,log="xy",ylab="")
mod <- lm(log(seed_size)~asin(sqrt(mature_RA_mean)), data=subset(SummarySpp,species!="BAER"))
words.bottom.left.logxy(mod)
legend(.05,.28,col=col.spp, legend=labels.spp(), pch=16, cex=.8,bty="n")
plot(mature_RA_mean~LMA_mean, data=subset(SummarySpp), col=col.spp(species),pch=16,log="xy",ylab="")
mod <- lm(log(LMA_mean)~asin(sqrt(mature_RA_mean)), data=subset(SummarySpp,species!="BAER"))
words.top.right.logxy(mod)
plot(mature_RA_mean~maxH, data=subset(SummarySpp), col=col.spp(species),pch=16,log="xy",ylab="")
...
plot(RA~WD_mean,data=subset(SummaryInd,RA>0), col=col.spp(species),pch=16,log="y",ylim=c(.0008,1))
points((RA+.001)~WD_mean,data=subset(SummaryInd,RA==0),col=col.spp(species),pch=16, cex=spp_zero_RA$RAcex)
...
words.bottom.left.logxy(mod)
plot(RA~LMA_mean, SummaryInd, col=col.spp(species),pch=16,log="xy",ylim=c(.0008,1))
points((RA+.001)~LMA_mean,data=subset(SummaryInd,RA==0),col=col.spp(species),pch=16, cex=sppage_zero_RA$RAcex)
