...
mod <- lm(log(FinalWeight)~asin(sqrt(RA)), data=subset(SummaryInd,ReproInv>0))
plot(asin(sqrt(RA))~FinalWeight, SummaryInd, log="x",col=col.spp[as.factor(species)],pch=16)
legend("topleft",legend=names(labels.spp),col=col.spp,pch=16, cex=.8,bty="n")
